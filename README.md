...
[![concluído - sem dias de código](Projetos%20e%20Códigos/more-infos/video/concluido-100-dias-de-codigo.gif)](Projetos%20e%20Códigos/more-infos/video/concluido-100-dias-de-codigo.gif)
...
**034** | Dia não muito produtivo, mas codei. Tentei resolver de novo um desafio de Java do @hackerrank.  Não consegui. Fui mexer num repo Git local e acabei dando Git Pull na hora de subir pro GitHub. Perdi alguns arquivos com o Merge, mas vida que segue...
**035** | Totalmente fora do planejamento destes 100 dias, criei minha primeira extensão para navegadores 😄. Seguindo um tutorial do [ProgramadorBr](https://www.youtube.com/watch?v=iVkSlNNShsk&t=844s), fiz uns complementos e vou acrescentar mais funcionalidades. Consegui publicá-la no [Firefox](https://addons.mozilla.org/pt-BR/firefox/addon/camel-letter-app/), mas ainda não publiquei no Chrome.
